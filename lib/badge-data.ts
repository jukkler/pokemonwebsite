...
const KANTO_BADGES: BadgeInfo[] = [
  ...
  { key: 'soul', nameEn: 'Soul Badge', nameDe: 'Sumpforden', leaderDe: 'Koga', imagePath: '/icons/badges/soul.png', gymNumber: 5 },
  { key: 'marsh', nameEn: 'Marsh Badge', nameDe: 'Moororden', leaderDe: 'Sabrina', imagePath: '/icons/badges/marsh.png', gymNumber: 6 },
...
const JOHTO_BADGES: BadgeInfo[] = [
  ...
  { key: 'plain', nameEn: 'Plain Badge', nameDe: 'Ebenenorden', leaderDe: 'Bianka', imagePath: '/icons/badges/plain.png', gymNumber: 3 },
  { key: 'fog', nameEn: 'Fog Badge', nameDe: 'Nebelorden', leaderDe: 'Jens', imagePath: '/icons/badges/fog.png', gymNumber: 4 },
  { key: 'storm', nameEn: 'Storm Badge', nameDe: 'Sturmorden', leaderDe: 'Hartwig', imagePath: '/icons/badges/storm.png', gymNumber: 5 },
  { key: 'mineral', nameEn: 'Mineral Badge', nameDe: 'Mineralorden', leaderDe: 'Jasmin', imagePath: '/icons/badges/mineral.png', gymNumber: 6 },
  { key: 'glacier', nameEn: 'Glacier Badge', nameDe: 'Gletscherorden', leaderDe: 'Norbert', imagePath: '/icons/badges/glacier.png', gymNumber: 7 },
  { key: 'rising', nameEn: 'Rising Badge', nameDe: 'Aufgangsorden', leaderDe: 'Sandra', imagePath: '/icons/badges/rising.png', gymNumber: 8 },
];
...
const HOENN_BADGES: BadgeInfo[] = [
  ...
  { key: 'rain', nameEn: 'Rain Badge', nameDe: 'Regenorden', leaderDe: 'Wassili', imagePath: '/icons/badges/rain.png', gymNumber: 8 },
];
...
const SINNOH_BADGES: BadgeInfo[] = [
  ...
  { key: 'cobble', nameEn: 'Cobble Badge', nameDe: 'Pflasterorden', leaderDe: 'Hilda', imagePath: '/icons/badges/cobble.png', gymNumber: 3 },
  { key: 'fen', nameEn: 'Fen Badge', nameDe: 'Sumpforden', leaderDe: 'Marinus', imagePath: '/icons/badges/fen.png', gymNumber: 4 },
  ...
  { key: 'icicle', nameEn: 'Icicle Badge', nameDe: 'Eiszapfenorden', leaderDe: 'Frida', imagePath: '/icons/badges/icicle.png', gymNumber: 7 },
  { key: 'beacon', nameEn: 'Beacon Badge', nameDe: 'Leuchtorden', leaderDe: 'Volkner', imagePath: '/icons/badges/beacon.png', gymNumber: 8 },
];
...
const UNOVA_BW_BADGES: BadgeInfo[] = [
  ...
  { key: 'quake', nameEn: 'Quake Badge', nameDe: 'Bebenorden', leaderDe: 'Turner', imagePath: '/icons/badges/quake.png', gymNumber: 5 },
  { key: 'jet', nameEn: 'Jet Badge', nameDe: 'Jetorden', leaderDe: 'Géraldine', imagePath: '/icons/badges/jet.png', gymNumber: 6 },
  { key: 'freeze', nameEn: 'Freeze Badge', nameDe: 'Frostorden', leaderDe: 'Sandro', imagePath: '/icons/badges/freeze.png', gymNumber: 7 },
...
const KALOS_BADGES: BadgeInfo[] = [
  { key: 'bug_badge', nameEn: 'Bug Badge', nameDe: 'Käferorden', leaderDe: 'Viola', imagePath: '/icons/badges/bug_badge.png', gymNumber: 1 },
  { key: 'cliff', nameEn: 'Cliff Badge', nameDe: 'Kletterorden', leaderDe: 'Lino', imagePath: '/icons/badges/cliff.png', gymNumber: 2 },
  { key: 'rumble', nameEn: 'Rumble Badge', nameDe: 'Kampforden', leaderDe: 'Connie', imagePath: '/icons/badges/rumble.png', gymNumber: 3 },
  { key: 'plant', nameEn: 'Plant Badge', nameDe: 'Pflanzenorden', leaderDe: 'Amaro', imagePath: '/icons/badges/plant.png', gymNumber: 4 },
  { key: 'voltage', nameEn: 'Voltage Badge', nameDe: 'Spannungsorden', leaderDe: 'Citro', imagePath: '/icons/badges/voltage.png', gymNumber: 5 },
  { key: 'fairy_badge', nameEn: 'Fairy Badge', nameDe: 'Feenorden', leaderDe: 'Valerie', imagePath: '/icons/badges/fairy_badge.png', gymNumber: 6 },
  { key: 'psychic_badge', nameEn: 'Psychic Badge', nameDe: 'Psycho-Orden', leaderDe: 'Astrid', imagePath: '/icons/badges/psychic_badge.png', gymNumber: 7 },
...
const GALAR_SWORD_BADGES: BadgeInfo[] = [
  { key: 'galar_grass', nameEn: 'Grass Badge', nameDe: 'Pflanzenorden', leaderDe: 'Yarro', imagePath: '/icons/badges/galar_grass.png', gymNumber: 1 },
  { key: 'galar_water', nameEn: 'Water Badge', nameDe: 'Wasserorden', leaderDe: 'Kate', imagePath: '/icons/badges/galar_water.png', gymNumber: 2 },
  { key: 'galar_fire', nameEn: 'Fire Badge', nameDe: 'Feuerorden', leaderDe: 'Kabu', imagePath: '/icons/badges/galar_fire.png', gymNumber: 3 },
  { key: 'galar_fighting', nameEn: 'Fighting Badge', nameDe: 'Kampforden', leaderDe: 'Saida', imagePath: '/icons/badges/galar_fighting.png', gymNumber: 4 },
  { key: 'galar_fairy', nameEn: 'Fairy Badge', nameDe: 'Feenorden', leaderDe: 'Papella', imagePath: '/icons/badges/galar_fairy.png', gymNumber: 5 },
  { key: 'galar_rock', nameEn: 'Rock Badge', nameDe: 'Gesteinsorden', leaderDe: 'Mac', imagePath: '/icons/badges/galar_rock.png', gymNumber: 6 },
  { key: 'galar_dark', nameEn: 'Dark Badge', nameDe: 'Unlichtorden', leaderDe: 'Nezz', imagePath: '/icons/badges/galar_dark.png', gymNumber: 7 },
  { key: 'galar_dragon', nameEn: 'Dragon Badge', nameDe: 'Drachenorden', leaderDe: 'Roy', imagePath: '/icons/badges/galar_dragon.png', gymNumber: 8 },
];
...
const GALAR_SHIELD_BADGES: BadgeInfo[] = [
  ...
  { key: 'galar_water', nameEn: 'Water Badge', nameDe: 'Wasserorden', leaderDe: 'Kate', imagePath: '/icons/badges/galar_water.png', gymNumber: 2 },
  { key: 'galar_fire', nameEn: 'Fire Badge', nameDe: 'Feuerorden', leaderDe: 'Kabu', imagePath: '/icons/badges/galar_fire.png', gymNumber: 3 },
  { key: 'galar_ghost', nameEn: 'Ghost Badge', nameDe: 'Geisterorden', leaderDe: 'Nio', imagePath: '/icons/badges/galar_ghost.png', gymNumber: 4 },
  { key: 'galar_fairy', nameEn: 'Fairy Badge', nameDe: 'Feenorden', leaderDe: 'Papella', imagePath: '/icons/badges/galar_fairy.png', gymNumber: 5 },
  { key: 'galar_ice', nameEn: 'Ice Badge', nameDe: 'Eisorden', leaderDe: 'Mel', imagePath: '/icons/badges/galar_ice.png', gymNumber: 6 },
  { key: 'galar_dark', nameEn: 'Dark Badge', nameDe: 'Unlichtorden', leaderDe: 'Nezz', imagePath: '/icons/badges/galar_dark.png', gymNumber: 7 },
  { key: 'galar_dragon', nameEn: 'Dragon Badge', nameDe: 'Drachenorden', leaderDe: 'Roy', imagePath: '/icons/badges/galar_dragon.png', gymNumber: 8 },
];

const PALDEA_BADGES: BadgeInfo[] = [
  { key: 'paldea_bug', nameEn: 'Bug Badge', nameDe: 'Käferorden', leaderDe: 'Ronah', imagePath: '/icons/badges/paldea_bug.png', gymNumber: 1 },
  { key: 'paldea_grass', nameEn: 'Grass Badge', nameDe: 'Pflanzenorden', leaderDe: 'Colzo', imagePath: '/icons/badges/paldea_grass.png', gymNumber: 2 },
  { key: 'paldea_electric', nameEn: 'Electric Badge', nameDe: 'Elektroorden', leaderDe: 'Enigmara', imagePath: '/icons/badges/paldea_electric.png', gymNumber: 3 },
  { key: 'paldea_water', nameEn: 'Water Badge', nameDe: 'Wasserorden', leaderDe: 'Kofu', imagePath: '/icons/badges/paldea_water.png', gymNumber: 4 },
  { key: 'paldea_normal', nameEn: 'Normal Badge', nameDe: 'Normalorden', leaderDe: 'Aoki', imagePath: '/icons/badges/paldea_normal.png', gymNumber: 5 },
  { key: 'paldea_ghost', nameEn: 'Ghost Badge', nameDe: 'Geisterorden', leaderDe: 'Etta', imagePath: '/icons/badges/paldea_ghost.png', gymNumber: 6 },
  { key: 'paldea_psychic', nameEn: 'Psychic Badge', nameDe: 'Psycho-Orden', leaderDe: 'Tulipa', imagePath: '/icons/badges/paldea_psychic.png', gymNumber: 7 },
  { key: 'paldea_ice', nameEn: 'Ice Badge', nameDe: 'Eisorden', leaderDe: 'Grusha', imagePath: '/icons/badges/paldea_ice.png', gymNumber: 8 },
];
